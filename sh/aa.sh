...
ess stream airlineontime --threads 3 --progress '*' '*' "aq_pp -f,+1,eok,csv - -d i:yearint i@3:month i@4:dayofmonth s@6:date s@7:carrier i@8:airlineid f@26:delay f@28:delay15 -filt \"airlineid==19805\" -eval s:year \"ToS(yearint)\" -eval i:numflights \"1\" -eval f:totaldelay \"delay\" -eval f:avgdelay \"totaldelay/numflights\" -eval f:numdelay15 \"delay15\" -udb_imp airline:vector1" 
