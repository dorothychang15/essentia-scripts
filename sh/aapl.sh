#!/bin/bash
# extracts desired fields from SEC spread data, filters for Apple ticker
...
ess stream sec '*' '*' 'aq_pp -f,+1,eok,qui,csv - -d s@1:ticker i@2:tradevol -filt "ticker==\"AAPL\""' > aapl.csv
