...
ess stream airlineontime --threads 3 --progress '2009-01-01' '2015-01-01' "aq_pp -f,+1,eok,qui,csv - -d i:yearint s@6:date s@7:carrier i@8:airlineid f@33:delay f@34:delay15 -filt \"airlineid==19393\" -eval s:year \"ToS(yearint)\" -eval i:numflights \"1\" -eval f:totaldelay \"delay\" -eval f:numdelay15 \"delay15\" -udb_imp airline:vector1" 
aq_udb -exp airline:vector1 > wnupdate.csv
